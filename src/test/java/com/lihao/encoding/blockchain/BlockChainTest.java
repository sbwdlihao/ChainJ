...
public class BlockChainTest {
    ...
    public void testVarInt31() throws IOException {
        ...
        assertThat(BlockChain.readVarInt31(new ByteArrayInputStream(bo.toByteArray()), null)).isEqualTo(0);
        ...
        assertThat(BlockChain.readVarInt31(new ByteArrayInputStream(bo.toByteArray()), null)).isEqualTo(500);
        ...
        assertThat(BlockChain.readVarInt31(new ByteArrayInputStream(bo.toByteArray()), null)).isEqualTo(0x7fffffff);
    ...
    public void testVarInt63() throws IOException {
        ...
        assertThat(bo.toByteArray()).isEqualTo(new byte[]{0});
        assertThat(BlockChain.readVarInt63(new ByteArrayInputStream(bo.toByteArray()), null)).isEqualTo(0);

        bo = new ByteArrayOutputStream();
        assertThat(BlockChain.writeVarInt63(bo, 500)).isEqualTo(2);
        assertThat(bo.toByteArray()).isEqualTo(new byte[]{(byte)0xf4, (byte)0x03});
        assertThat(BlockChain.readVarInt63(new ByteArrayInputStream(bo.toByteArray()), null)).isEqualTo(500);
        ...
        assertThat(BlockChain.readVarInt63(new ByteArrayInputStream(bo.toByteArray()), null)).isEqualTo(0x80000000L);
    ...
    public void testVarStr() throws IOException {
        ...
        assertThat(bo.toByteArray()).isEqualTo(new byte[]{0});
        byte[] out = BlockChain.readVarStr31(new ByteArrayInputStream(bo.toByteArray()), null);
        ...
        assertThat(bo.toByteArray()).isEqualTo(new byte[]{0});
        byte[] out1 = BlockChain.readVarStr31(new ByteArrayInputStream(bo.toByteArray()), null);
